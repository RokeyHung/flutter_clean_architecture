// CORE - theme/themes/aurora_eternal_frost_theme.dart
// "Aurora of Eternal Frost" — theme mặc định của app.
import 'package:flutter/material.dart';
import '../app_theme_data.dart';

class AuroraEternalFrostTheme implements AppThemeData {
  final TextTheme textTheme;

  const AuroraEternalFrostTheme(this.textTheme);

  @override
  String get id => 'aurora_eternal_frost';

  @override
  String get displayName => 'Aurora of Eternal Frost';
  ...
  ThemeData lightMediumContrast() => _theme(lightMediumContrastScheme());
  ...
  ThemeData lightHighContrast() => _theme(lightHighContrastScheme());
  ...
  ThemeData darkMediumContrast() => _theme(darkMediumContrastScheme());
  ...
  // ── Extended colors (reserved for future use) ───────────────────────────────
